 ...
 * 
 * App component
 * This is the outermost container component of the project.
 * On load it will either display the phone or the login component. This is based off of the state.step
 * 
 * 
 * 
 * 
...
export default class App extends React.Component
{
	constructor(props)
	{
		...
		this.state =
		{
			...
			//settings is the setting object (UA information)
			settings        : settingsManager.get(),
			//Snackbar is the message handler that is in the lower left on events. I need to look into this more to understand it. 
			showSnackbar    : false,
	...
	render()
	{
		...
		{
			/**
			 * Loads in either the login or the phone. 
			 */
			case 'login':
			{
				component =
