...
/**
 * This component shows the current account, text field for what uri you want to call, and the call button
 * 
*/
		...
		return (
			<div data-component='Dialer'>
				<div className='userchip-container'>
					{/* This is the 'status' bubble that shows the registration status */}
					<UserChip
				...
				{/* The form where you input the uri you want to call, and the call button */}
				<form
