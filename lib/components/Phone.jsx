...
/**
 * Component for the main phone page (main page)
 * Consists mainly of dialer, sesion, and incoming components
 * jsSip object handles the Signalling for the calls. Read up on the JsSip docs for how it works.
 */
export default class Phone extends React.Component
{
				...
				<div data-component='Phone'>
					<header>
						<div className='topbar'>
							...
							>
								{/* Dont really need these buttons
						...
						{/* This is the white section near the top It. Look at the Dialer component for more info*/}
						<Dialer
					...
					{/* Content will either be session (call process happening) or incomingSession (incoming call handling) or nothing*/}
	...
	componentDidMount()
	{
		...
		/**
		 * These following event handlers are for the UA events. 
		 */
	...
	**/
	...
	handleOutgoingCall(uri)
	{
		...
		//Session event handling. Possible but media recording here.  
